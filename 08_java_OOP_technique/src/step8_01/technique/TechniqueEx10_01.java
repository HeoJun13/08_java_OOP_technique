...
import step8_01.technique.AA.BB;
import step8_01.technique.AA.CC;
...
abstract class AA {
	...
	interface BB {
		...
		//void test5() {}
		//일반 메서드 앞에 default 키워드를 붙인다.
		default void test5() { 
			System.out.println("default 메서드");
		}
		
		//정적 메서드 앞에 static 키워드를 붙인다.
		static void test6 () {
...
// implements 키워드를 사용하면서 인터페이스를 '구현'한다. (상속x)
