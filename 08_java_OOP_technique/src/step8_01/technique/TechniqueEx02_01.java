...
class ModifierTest {
	...
	// private 변수를 외부로 수정하는 메서드 setter
...
public class TechniqueEx02_01 {
	...
	public static void main(String[] args) {
		...
		// ptivate 변수는 클래스 외부에서 접근 불가
		//test.a = 1000;
		//System.out.println(test.a);
		
		test.setA(1000); 					// setter을 사용하여 private변수에 데이터 수정
		System.out.println(test.getA());	// setter을 사용하여 private변수에 데이터 반환
		...
		//productDTO.productNm = "0x001";
		
		productDTO.setProductCd("0x001");
		productDTO.setBrandNm("기계식키보드");
